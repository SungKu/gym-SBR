...
def batch_time(t_cycle, t_ratio, t_delta):
    ...
    t_save1 = np.linspace(t_start, t_end, (t_end - t_start) / (t_delta * 10))
    ...
    t_save3 = np.linspace(t_start, t_end, (t_end - t_start) / (t_delta * 10))
    ...
    t_save4 = np.linspace(t_start, t_end, (t_end - t_start) / (t_delta * 10))
    ...
    t_save5 = np.linspace(t_start, t_end, (t_end - t_start) / (t_delta * 10))
    ...
    t_save6 = np.linspace(t_start, t_end, (t_end - t_start) / (t_delta * 10))
    ...
    t_save7 = np.linspace(t_start, t_end, (t_end - t_start) / (t_delta * 10))
    ...
    t_save8 = np.linspace(t_start, t_end, (t_end - t_start) / (t_delta * 10))
    ...
    return t_memory1, t_memory2, t_memory3, t_memory4, t_memory5, t_memory8
